(function() {
    ...
    const initializeExperiment = function() {
        ...
        const objects = [
            "NOUN_objects_64/1.jpg", "NOUN_objects_64/2.jpg", "NOUN_objects_64/3.jpg", "NOUN_objects_64/4.jpg",
            "NOUN_objects_64/5.jpg", "NOUN_objects_64/6.jpg", "NOUN_objects_64/7.jpg", "NOUN_objects_64/8.jpg",
            "NOUN_objects_64/9.jpg", "NOUN_objects_64/10.jpg", "NOUN_objects_64/11.jpg", "NOUN_objects_64/12.jpg",
            "NOUN_objects_64/13.jpg", "NOUN_objects_64/14.jpg", "NOUN_objects_64/15.jpg", "NOUN_objects_64/16.jpg",
            "NOUN_objects_64/17.jpg", "NOUN_objects_64/18.jpg", "NOUN_objects_64/19.jpg", "NOUN_objects_64/20.jpg",
            "NOUN_objects_64/21.jpg", "NOUN_objects_64/22.jpg", "NOUN_objects_64/23.jpg", "NOUN_objects_64/24.jpg",
            "NOUN_objects_64/25.jpg", "NOUN_objects_64/26.jpg", "NOUN_objects_64/27.jpg", "NOUN_objects_64/28.jpg",
            "NOUN_objects_64/29.jpg", "NOUN_objects_64/30.jpg", "NOUN_objects_64/31.jpg", "NOUN_objects_64/32.jpg",
            "NOUN_objects_64/33.jpeg", "NOUN_objects_64/34.jpg", "NOUN_objects_64/35.jpg", "NOUN_objects_64/36.jpg",
            "NOUN_objects_64/37.jpg", "NOUN_objects_64/38.jpg", "NOUN_objects_64/39.jpg", "NOUN_objects_64/40.jpg",
            "NOUN_objects_64/41.jpg", "NOUN_objects_64/42.jpg", "NOUN_objects_64/43.jpg", "NOUN_objects_64/44.jpg",
            "NOUN_objects_64/45.jpg", "NOUN_objects_64/46.jpg", "NOUN_objects_64/47.jpg", "NOUN_objects_64/48.jpg",
            "NOUN_objects_64/49.jpg", "NOUN_objects_64/50.jpg", "NOUN_objects_64/51.jpg", "NOUN_objects_64/52.jpg",
            "NOUN_objects_64/53.jpg", "NOUN_objects_64/54.jpg", "NOUN_objects_64/55.jpg", "NOUN_objects_64/56.jpg",
            "NOUN_objects_64/57.jpg", "NOUN_objects_64/58.jpg", "NOUN_objects_64/59.jpg", "NOUN_objects_64/60.jpg",
            "NOUN_objects_64/61.jpg", "NOUN_objects_64/62.jpg", "NOUN_objects_64/63.jpg", "NOUN_objects_64/64.jpg"
        ];
       ...
       // Set repetition and block parameters
        ...
        // Shuffle the full permutation list deterministically using resultId as a seed surrogate
        const selectedPhaseOrder = allPermutations[resultId % allPermutations.length];
    ...
    let objectCounts = {};
    for (let i = 1; i <= 64; i++) {
        objectCounts[`NOUN_objects_64/${i}.jpg`] = 0;
    }
...
function displayTaskResults(taskKey) {
    if (!taskKey || !results.tasks.hasOwnProperty(taskKey)) {
        ...
        if (resultsOverlay) {
            ...
            const taskKey = currentTaskKey(); // e.g., "1D_congruent_Spatial" or "inter_A_Spatial"
            let phaseKey;

            if (taskKey.toLowerCase().startsWith("inter_a")) {
                phaseKey = "inter_A";
            } else if (taskKey.toLowerCase().startsWith("inter_b")) {
                phaseKey = "inter_B";
            } else {
                // Strip trailing "_Spatial" or "_Categorization" and fix "1d_" capitalization
                phaseKey = taskKey
                    .replace(/_(spatial|categorization)$/i, '')
                    .replace(/^1d_/, "1D_"); // normalize "1d_" to "1D_"
            }
    ...
    function proceedToNextTrial(fromRestScreen = false) {
        ...
        if (!group || taskIndex >= group.length) {
            ...
            if (taskOrder.length === 4 && currentTask().includes('Spatial')) {
